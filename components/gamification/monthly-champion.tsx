...
const events = [
  {
    ...
    description: 'Join us for a day of environmental restoration',
    date: 'July 20, 2024',
  ...
  {
    id: 'e2',
    name: 'Sustainability Lunch & Learn',
    description: 'Expert panel discussing net-zero transition strategies',
    date: 'July 15, 2024',
  ...
  },
  {
    ...
    description: 'Coastal cleanup and marine conservation effort',
    date: 'July 22, 2024',
  ...
  {
    id: 'e4',
    name: 'Carbon Accounting Workshop',
    description: 'Learn to calculate and manage corporate emissions',
    date: 'July 10, 2024',
  ...
  },
  {
    ...
    description: 'Challenge your team to use eco-friendly transportation',
    date: 'July 1 - 7, 2024',
    time: 'All day',
...
const eventColors = {
  ...
  Challenge: 'bg-orange-100 text-orange-900',
}
  ...
  return (
    <Tabs defaultValue="champion" className="space-y-6">
      ...
      <TabsContent value="champion" className="space-y-6">
        {/* Current Champion */}
        <Card className="border-2 border-yellow-400 bg-gradient-to-r from-yellow-50 to-transparent">
          <CardHeader>
            <div className="flex items-center gap-3 mb-4">
              <Crown className="w-6 h-6 text-yellow-500" />
              <CardTitle>July 2024 Champion</CardTitle>
            </div>
          </CardHeader>
